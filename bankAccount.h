...
ostream& operator <<(ostream& osObject, const bankAccount& bankAccountObj) {
	osObject << "-------------------------------------" << endl
		<< "Name: " << bankAccountObj.personName << endl
		<< "Surname: " << bankAccountObj.personSurname << endl
		<< "Phone Number: " << bankAccountObj.personPhone << endl
		<< "Balance: " << bankAccountObj.accountBalance << endl;
	return osObject;
}
